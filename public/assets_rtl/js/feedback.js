...
(function (phoenix) {
    ...
    var feedbackContent = (function (_super) {
        ...
        feedbackContent.prototype.html2Canvas = function (documentWidth, docoumentheight) {
            ...
            html2canvas($('body'), {
               ...
               //     $('#fb-overview').show();
                    setTimeout(function () {
                        $('#fb-screenshot').html('').append('<a href="' + img + '" target="_blank" ><img id="image" class="fb-screenshot fb-screenshot-border fb-screenshot-fadeIn" src="' + img + '" /></a>');
        ...
        feedbackContent.prototype.submitFeedback = function () {
            ...
            $.ajax({
                ...
                dataType: 'json',
                type: 'POST',
                data: { description: $('.description').val(), type: $('#type').val(),image: $('#fb-screenshot').val() },
        ...
        feedbackContent.prototype.getfbTemplate = function (html2canvasSupport) {
            if (html2canvasSupport)
                console.log(html2canvasSupport);
                return {
                    isSuccessfull: true,
    ...
    var feedbackOptions = (function () {
        function feedbackOptions(onStart, onClose, url, contentTemplate) {
            ...
            if (typeof url === "undefined") { url = "/feedback"; }
            if (typeof contentTemplate === "undefined") { contentTemplate = "/template"; }
