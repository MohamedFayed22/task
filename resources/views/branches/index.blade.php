    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">{{ __('pages.groups') }}</span> - {{__('pages.Show-all')}}</h4>
            </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-component">
            <ul class="breadcrumb">
                ...
                <li class="active">{{ __('companies') }}</li>
            </ul>
    ...
    @include('particals.messages')
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">{{ __('pages.groups') }}</h5>
                <div class="heading-elements">
                    <ul class="icons-list">
