...
class BranchesDataTable extends DataTable
{
    ...
    {
        return $model->newQuery()->select('id', 'name', 'phone', 'address', 'field', 'visites_date', 'country_id','branches' ,'created_at', 'updated_at')->where('branches','!=',0);
    }
...
//                    ['extend' =>'create' , 'text' =>  '<i class="fa fa-plus"></i>'. __('pages.create') , 'className' =>'dt-button buttons-copy buttons-html5 btn btn-default legitRipple'],
    ...
    protected function getColumns()
    {
        return [
            ...
            'branches' => ['name' => 'branches' ,'data' => 'branches' ,'title' => __('pages.branches')],
